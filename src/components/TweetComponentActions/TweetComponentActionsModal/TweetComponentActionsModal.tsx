            ...
            <DialogContent style={{ padding: 0 }}>
                <div className={classes.modalWrapper}>
                    <Typography variant={"h5"}>
                        {modalTitle === "Delete" ? "Delete Tweet?" : isTweetPinned ? "Unpin Tweet from profile?" : "Pin Tweet to profile?"}
                    </Typography>
                    ...
                    <div className={classes.modalButtonWrapper}>
                        <Button className={classes.modalCancelButton} onClick={onCloseTweetComponentActionsModal} variant="contained" size="large">
                            Cancel
                        </Button>
                        <Button
                            ...
                            size="large"
                        >
                            {modalTitle === "Delete" ? "Delete" : isTweetPinned ? "Unpin" : "Pin"}
                        </Button>
                    </div>
                </div>
            </DialogContent>
