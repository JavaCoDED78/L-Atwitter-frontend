...
const BlockUserModal: FC<BlockUserModalProps> = ({ username, isUserBlocked, visible, onClose, onBlockUser }): ReactElement | null => {
    ...
    return (
        <Dialog className={classes.dialog} open={visible} onClick={(event) => event.preventDefault()} onClose={onClose}>
            <DialogContent>
                ...
                <Button
                    className={classNames(classes.containedButton, isUserBlocked ? classes.unblockButton : classes.blockButton)}
                    onClick={onBlockUser}
                    variant="contained"
                    color="primary"
                    size="large"
                ...
                <Button onClick={onClose} color="primary" variant="outlined" size="large" fullWidth>
                    Cancel
                </Button>
            </DialogContent>
        </Dialog>
