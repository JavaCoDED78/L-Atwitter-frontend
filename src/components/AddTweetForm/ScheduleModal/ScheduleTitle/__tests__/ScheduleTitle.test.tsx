...
describe("ScheduleTitle", () => {
    ...
    it("should render Update button", () => {
        ...
        const wrapper = mountWithStore(
            <ScheduleTitle onClose={jest.fn()} isValidSelectedDate onSubmitScheduleDate={jest.fn()} onSubmitClearScheduleDate={jest.fn()} />,
            mockRootState
        );
    ...
    it("should render Confirm button", () => {
        const wrapper = mountWithStore(
            <ScheduleTitle onClose={jest.fn()} isValidSelectedDate={false} onSubmitScheduleDate={jest.fn()} onSubmitClearScheduleDate={jest.fn()} />,
            mockStore
        );
