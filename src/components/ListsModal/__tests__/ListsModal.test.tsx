...
describe("ListsModal", () => {
    ...
    it("should render loading Spinner", () => {
        const wrapper = mountWithStore(<ListsModal userId={1} visible={true} onClose={jest.fn()} />, createMockRootState(LoadingStatus.LOADING));
    ...
    it("should render correctly", () => {
        const wrapper = mountWithStore(<ListsModal userId={1} visible={true} onClose={jest.fn()} />, mockListsState);
    ...
    it("should click submit", () => {
        ...
        const wrapper = mountWithStore(<ListsModal userId={1} visible={true} onClose={mockOnClose} />, mockListsState);
    ...
    it("should render empty ListsModal", () => {
        const wrapper = mountWithStore(<ListsModal userId={1} visible={false} onClose={jest.fn()} />, mockListsState);
