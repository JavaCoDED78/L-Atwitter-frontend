...
describe("ConnectToUsers", () => {
    ...
    it("should render loading spinner", () => {
        const wrapper = mountWithStore(<ConnectToUsers title={"Followers you know"} isUsersLoading={true} users={[]} />, mockRootState);

        expect(wrapper.find(Spinner).exists()).toBe(true);
    });

    it("should render UsersItem list", () => {
        const wrapper = mountWithStore(<ConnectToUsers title={"Followers you know"} isUsersLoading={true} users={mockUsers} />, mockRootState);
