...
import { selectListItemFollowersSize, selectListItemId, selectListItemMembersSize, selectListItemOwnerId } from "../../../store/ducks/list/selectors";
...
const MembersAndFollowers = memo((): ReactElement => {
    ...
    return (
        <div>
            <FullListUserCount id={"listMembers"} userCount={membersSize} title={"members"} onOpenModalWindow={onOpenModalWindow} />
            <FullListUserCount id={"listFollowers"} userCount={followersSize} title={"followers"} onOpenModalWindow={onOpenModalWindow} />
