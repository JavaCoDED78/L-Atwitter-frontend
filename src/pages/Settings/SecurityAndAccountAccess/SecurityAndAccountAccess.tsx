            ...
            <div className={globalClasses.listItemWrapper}>
                <List component="nav" aria-label="main mailbox folders">
                    <Link to={SETTINGS_SECURITY}>
                        <ListItem>
                            <div className={globalClasses.listIconWrapper}>{SecurityIcon}</div>
                            <div>
                    ...
                    <Link to={SETTINGS_SECURITY_APPS_AND_SESSIONS}>
                        <ListItem>
                            <div className={globalClasses.listIconWrapper}>{AppsIcon}</div>
                            <div>
                                <Typography variant={"body1"} component={"div"}>
                                    Apps and sessions
                                </Typography>
                    ...
                    <ListItem>
                        <div className={globalClasses.listIconWrapper}>{ConnectedIcon}</div>
                        <div>
                            <Typography variant={"body1"} component={"div"}>
                                Connected accounts
                            </Typography>
