            ...
            <div className={classnames(classes.listWrapper, globalClasses.listItemWrapper)}>
                <List component="nav" aria-label="main mailbox folders">
                    <Link to={SETTINGS_PRIVACY_AND_SAFETY_AUDIENCE}>
                        <ListItem>
                            <div className={globalClasses.listIconWrapper}>{AudienceIcon}</div>
                            <div>
                    ...
                    <Link to={SETTINGS_PRIVACY_AND_SAFETY_YOUR_TWEETS}>
                        <ListItem>
                            <div className={globalClasses.listIconWrapper}>{QuoteTweetIcon}</div>
                            <div>
                                <Typography variant={"body1"} component={"div"}>
                                    Your Tweets
                                </Typography>
                    ...
                    <Link to={SETTINGS_PRIVACY_AND_SAFETY_CONTENT_YOU_SEE}>
                        <ListItem>
                            <div className={globalClasses.listIconWrapper}>{ContentIcon}</div>
                            <div>
                                <Typography variant={"body1"} component={"div"}>
                                    Content you see
                                </Typography>
                    ...
                    <Link to={SETTINGS_PRIVACY_AND_SAFETY_MUTE_AND_BLOCK}>
                        <ListItem>
                            <div className={globalClasses.listIconWrapper}>{MuteIcon}</div>
                            <div>
                                <Typography variant={"body1"} component={"div"}>
                                    Mute and block
                                </Typography>
                    ...
                    <Link to={SETTINGS_PRIVACY_AND_SAFETY_DIRECT_MESSAGES}>
                        <ListItem>
                            <div className={globalClasses.listIconWrapper}>{MessagesIcon}</div>
                            <div>
                                <Typography variant={"body1"} component={"div"}>
                                    Direct Messages
                                </Typography>
                    ...
                    <Link to={SETTINGS_PRIVACY_AND_SAFETY_SPACES}>
                        <ListItem>
                            <div className={globalClasses.listIconWrapper}>{SpacesIcon}</div>
                            <div>
                                <Typography variant={"body1"} component={"div"}>
                                    Spaces
                                </Typography>
                    ...
                    <Link to={SETTINGS_PRIVACY_AND_SAFETY_CONTACTS}>
                        <ListItem>
                            <div className={globalClasses.listIconWrapper}>{DiscoverIcon}</div>
                            <div>
                                <Typography variant={"body1"} component={"div"}>
                    ...
                    <Link to={SETTINGS_PRIVACY_AND_SAFETY_ADS_PREFERENCES}>
                        <ListItem>
                            <div className={globalClasses.listIconWrapper}>{AdsIcon}</div>
                            <div>
                                <Typography variant={"body1"} component={"div"}>
                                    Ads preferences
                                </Typography>
                    ...
                    <Link to={SETTINGS_PRIVACY_AND_SAFETY_OFF_TWITTER_ACTIVITY}>
                        <ListItem>
                            <div className={globalClasses.listIconWrapper}>{OffTwitterIcon}</div>
                            <div>
                                <Typography variant={"body1"} component={"div"}>
                                    Off-Twitter activity
                                </Typography>
                                <Typography variant={"subtitle2"} component={"div"}>
                                    Manage how Twitter uses your online activity outside of Twitter, such as the websites you visit, to personalize
                                    your experience.
                                </Typography>
                            </div>
                            <div className={globalClasses.arrowIcon}>{ArrowRightIcon}</div>
                    ...
                    <Link to={SETTINGS_PRIVACY_AND_SAFETY_DATA_SHARING_WITH_BUSINESS_PARTNERS}>
                        <ListItem>
                            <div className={globalClasses.listIconWrapper}>{DataSharingIcon}</div>
                            <div>
                                <Typography variant={"body1"} component={"div"}>
                    ...
                    <Link to={SETTINGS_PRIVACY_AND_SAFETY_LOCATION_INFORMATION}>
                        <ListItem>
                            <div className={globalClasses.listIconWrapper}>{LocationIcon}</div>
                            <div>
                                <Typography variant={"body1"} component={"div"}>
                    ...
                    <a href={PRIVACY_TWITTER} target={"_blank"} rel={"noreferrer noopener"}>
                        <ListItem>
                            <div>
                                <Typography variant={"body1"} component={"div"}>
                                    Privacy center
                    ...
                    <a href={TWITTER_PRIVACY} target={"_blank"} rel={"noreferrer noopener"}>
                        <ListItem>
                            <div>
                                <Typography variant={"body1"} component={"div"}>
                                    Privacy policy
                    ...
                    <a href={FORMS_PRIVACY} target={"_blank"} rel={"noreferrer noopener"}>
                        <ListItem>
                            <div>
                                <Typography variant={"body1"} component={"div"}>
                                    Contact us
