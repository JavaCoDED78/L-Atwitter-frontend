            ...
            <Paper className={classes.container}>
                ...
                <div style={{ flex: 1 }}>
                    <div className={classes.userInfoWrapper}>
                        <BlockedAccountInfo fullName={blockedUser.fullName} username={blockedUser.username} about={blockedUser.about} />
                        <BlockAccountButton userId={blockedUser.id} username={blockedUser.username} isUserBlocked={blockedUser.isUserBlocked} />
                    </div>
                </div>
            </Paper>
        </Link>
