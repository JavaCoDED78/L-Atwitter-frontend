...
export const useFollowedTopicItemButton = makeStyles<Theme, UseFollowedTopicButtonStyles>((theme) => ({
    topicItem: {
        ...
        "& svg": {
            width: "1.172rem",
            height: "1.172rem",
            fill: (props: { isTopicNotInterested: any }) =>
                props.isTopicNotInterested ? theme.palette.background.default : theme.palette.primary.main,
            transition:
                "fill 250ms cubic-bezier(0.4, 0, 0.2, 1) 0ms,box-shadow 250ms cubic-bezier(0.4, 0, 0.2, 1) 0ms,border 250ms cubic-bezier(0.4, 0, 0.2, 1) 0ms"
        },
        "& hr": {
    ...
    topicItemCloseButton: {
        "&.MuiButtonBase-root": {
            ...
            "& svg": {
                fill: (props: { isTopicNotInterested: any; isTopicFollowed: any }) =>
                    props.isTopicNotInterested
                        ? theme.palette.background.default
                        : props.isTopicFollowed
                        ? theme.palette.primary.main
