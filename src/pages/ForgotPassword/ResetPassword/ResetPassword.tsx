    ...
    return (
        <>
            ...
            <div className={classes.userInfoWrapper}>
                <Avatar alt={`avatar`} className={classes.avatar} src={location.state.user?.avatar ?? DEFAULT_PROFILE_IMG} />
            ...
            <Typography variant={"body1"} component={"div"} className={classes.resetPasswordText}>
                ...
                <a href={ACCOUNT_SECURITY_TIPS} target={"_blank"} rel={"noreferrer noopener"}>
                    Learn more
                </a>
            </Typography>
