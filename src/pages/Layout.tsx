...
export const Layout: FC<Layout & DisplayProps> = ({ children, changeBackgroundColor, changeColorScheme }): ReactElement => {
                        ...
                        <div>
                            ...
                            <div className={classes.rightSide}>
                                ...
                                <div className={classes.footer}>
                                    <div>
                                        <a href={TWITTER_TOS} target={"_blank"} rel={"noreferrer noopener"}>
                                        ...
                                        <a href={TWITTER_COOKIES} target={"_blank"} rel={"noreferrer noopener"}>
                                            <Typography component={"span"}>Cookie Policy</Typography>
                                        </a>
                                    </div>
                                    <div>
                                        <a href={TWITTER_ADS_WORK} target={"_blank"} rel={"noreferrer noopener"}>
                                            <Typography component={"span"}>Ads info</Typography>
                                        </a>
                                        <Typography component={"span"}>More {EditIcon}</Typography>
                                        <Typography component={"span"}>{`© ${getYear(Date.now())} Twitter, Inc.`}</Typography>
                                    </div>
                                </div>
                            </div>
                        </div>
