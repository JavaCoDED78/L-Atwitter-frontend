...
describe("tweetReducer:", () => {
    ...
    describe("tweet handlers:", () => {
        ...
        testActionDispatch(
            ...
            tweetReducer({ ...initialTweetState, tweet: { id: 1 } as TweetResponse }, { type: TweetActionType.RESET_TWEET_STATE }),
            { ...initialTweetState, tweet: undefined }
        );

        testActionDispatch(
            TweetActionType.SET_LOADING_STATE,
            tweetReducer(initialTweetState, { type: TweetActionType.SET_LOADING_STATE, payload: LoadingStatus.SUCCESS }),
